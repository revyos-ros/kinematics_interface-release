...
The packages in the `kinematics_interface` repository were released into the `humble` distro by running `/home/z572/gits/revyos-ros/venv/bin/bloom-release -r humble kinematics_interface --override-release-repository-push-url git@github.com:revyos-ros/kinematics_interface-release.git` on `Tue, 17 Jun 2025 04:17:18 -0000`
...
The packages in the `kinematics_interface` repository were released into the `jazzy` distro by running `/home/z572/gits/revyos-ros/venv2/bin/bloom-release -r jazzy kinematics_interface --override-release-repository-push-url git@github.com:revyos-ros/kinematics_interface-release.git` on `Thu, 19 Dec 2024 06:28:58 -0000`
